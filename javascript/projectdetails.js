jQuery(document).ready(function () {
    ...
    function SetContact() {
        console.log("Setting contact section");
        $(".contact").append(`
                ...
                <a target="_blank" href="mailto:contact@kalpshah.dev" class="emailText">
                    <div class="mailhoverable">contact@kalpshah.dev</div>
                </a>
    ...
    <div class="nav">
        <div class="backbox hoverable">
          <div>➜</div>
        </div>
        <div class="titlebox">
            <div class="titletext hoverable"></div>
        </div>
    </div>
    <div id="smooth-wrapper">
      <div id="smooth-content">
        <div class="banner stretch"></div>
        <div class="brief">
            <div class="briefnotes"></div>
            <div class="brieftext"></div>
        </div>
        <div class="metrics">
            <div class="PageTitles">Metrics</div>
            <div class="metricsdiv stretchBox"></div>
        </div>
        <div class="gallery">
            <div class="PageTitles">Gallery</div>
            <ul class="gallerydiv"></ul>
        </div>
        <div class="reviews">
            <div class="PageTitles">Reviews</div>
            <div class="reviewsdiv stretchBox"></div>
        </div>
        <div class="contact stretch">
        </div>
    ...
    `);
        ...
        $(document).mousemove(function (e) {
            mouseX = e.pageX - (circleSize / 2);
            mouseY = e.pageY - (circleSize / 2);
        });
